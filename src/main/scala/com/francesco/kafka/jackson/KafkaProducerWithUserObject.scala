...
object KafkaProducerWithUserObject extends App{
  val props:Properties = new Properties()
  props.put("bootstrap.servers","worker1.zerofactorys.com:9092")
  props.put("key.serializer","org.apache.kafka.common.serialization.StringSerializer")
  props.put("value.serializer","com.francesco.kafka.jackson.UserSerializer")
  props.put("acks","all")
  val producer = new KafkaProducer[String, User](props)
  try{
    for(i <- 0 to 100) {
      val user = new User("My Name - "+i,i)
      val record = new ProducerRecord[String, User]("pippo",i.toString,user)
